...
| **Foco:** Interface e experiência do usuário. Estruturação das páginas, desenvolvimento da interface, organização da apresentação dos produtos e implementação de interações para melhorar a navegação. Projeto desenvolvido de forma independente, como freelancer, desde o layout até as funcionalidades. |
